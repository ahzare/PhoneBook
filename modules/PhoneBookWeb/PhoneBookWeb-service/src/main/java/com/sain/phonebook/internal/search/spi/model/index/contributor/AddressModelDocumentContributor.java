...
public class AddressModelDocumentContributor
	...
	@Override
	public void contribute(Document document, Address baseModel) {
		...
		/*try {
			...
			if (_log.isWarnEnabled()) {
				_log.warn(
						"Unable to index baseModel " + baseModel.getAddressId(), portalException);
			}
		}*/
	}

	private static final Log _log = LogFactoryUtil.getLog(
			AddressModelDocumentContributor.class);
