...
public class PartPersistenceImpl
	 ...
	 */
	@Override
	public List<Part> findByAddressId(long addressId) {
	 ...
	 */
	@Override
	public List<Part> findByAddressId(long addressId, int start, int end) {
	 ...
	 */
	@Override
	public List<Part> findByAddressId(
	...
	public List<Part> findByAddressId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Part part : list) {
					if (addressId != part.getAddressId()) {
						list = null;
	...
	public Part findByAddressId_First(
			long addressId, OrderByComparator<Part> orderByComparator)
		throws NoSuchPartException {

		Part part = fetchByAddressId_First(addressId, orderByComparator);
	...
	public Part fetchByAddressId_First(
		...
		List<Part> list = findByAddressId(addressId, 0, 1, orderByComparator);
	...
	public Part findByAddressId_Last(
		...
		Part part = fetchByAddressId_Last(addressId, orderByComparator);
	...
	public Part fetchByAddressId_Last(
		...
		List<Part> list = findByAddressId(
	...
	public Part[] findByAddressId_PrevAndNext(
		...
		try {
			...
			array[0] = getByAddressId_PrevAndNext(
				session, part, addressId, orderByComparator, true);

			array[1] = part;

			array[2] = getByAddressId_PrevAndNext(
				session, part, addressId, orderByComparator, false);
	...
	protected Part getByAddressId_PrevAndNext(
		Session session, Part part, long addressId,
		OrderByComparator<Part> orderByComparator, boolean previous) {
