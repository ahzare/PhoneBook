...
public class DepartmentPersistenceImpl
	...
	public Department findByDepartmentId(long departmentId)
		...
		Department department = fetchByDepartmentId(departmentId);
	 ...
	 */
	@Override
	public Department fetchByDepartmentId(
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"DepartmentPersistenceImpl.fetchByDepartmentId(long, boolean) with parameters (" +
	 ...
	 */
	@Override
	public Department removeByDepartmentId(long departmentId)
		throws NoSuchDepartmentException {
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {departmentModelImpl.getDepartmentId()};
