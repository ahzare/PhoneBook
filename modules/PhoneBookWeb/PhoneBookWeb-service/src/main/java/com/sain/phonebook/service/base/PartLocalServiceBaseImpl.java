 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sain.phonebook.service.impl.PartLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sain.phonebook.service.impl.PartLocalServiceImpl
 * @generated
 */
public abstract class PartLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PartLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PartLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PartLocalServiceUtil</code>.
	 */
	...
	public Part fetchPartByUuidAndGroupId(String uuid, long groupId) {
		return partPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Part>() {

				@Override
				public void performAction(Part part) throws PortalException {
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, part);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return partPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public BasePersistence<Part> getBasePersistence() {
	...
	public List<Part> getPartsByUuidAndCompanyId(String uuid, long companyId) {
		return partPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Part> getPartsByUuidAndCompanyId(
		...
		return partPersistence.findByUuid_C(
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(partLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		PartLocalService partLocalService) {

		try {
			Field field = PartLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, partLocalService);
		}
