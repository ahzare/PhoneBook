...
public class PersonPersistenceImpl
	...
	private FinderPath _finderPathFetchByPersonId;
	private FinderPath _finderPathCountByPersonId;
	...
	public Person findByPersonId(long personId) throws NoSuchPersonException {
		Person person = fetchByPersonId(personId);
	...
	public Person fetchByPersonId(long personId) {
		return fetchByPersonId(personId, true);
	}
	...
	public Person fetchByPersonId(long personId, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByPersonId, finderArgs, this);
		}
		...
		if (result == null) {
			...
			sb.append(_FINDER_COLUMN_PERSONID_PERSONID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					if (useFinderCache) {
						finderCache.putResult(
							_finderPathFetchByPersonId, finderArgs, list);
					}
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"PersonPersistenceImpl.fetchByPersonId(long, boolean) with parameters (" +
	...
	public int countByPersonId(long personId) {
		FinderPath finderPath = _finderPathCountByPersonId;
	...
	private static final String _FINDER_COLUMN_PERSONID_PERSONID_2 =
		"person.personId = ?";
	 ...
	 */
	@Override
	public List<Person> findByRoleId(long roleId, int start, int end) {
	 ...
	 */
	@Override
	public List<Person> findByRoleId(
	...
	public Person findByRoleId_First(
		...
		Person person = fetchByRoleId_First(roleId, orderByComparator);
	...
	public Person fetchByRoleId_First(
		...
		List<Person> list = findByRoleId(roleId, 0, 1, orderByComparator);
	...
	public Person findByRoleId_Last(
		...
		Person person = fetchByRoleId_Last(roleId, orderByComparator);
	...
	public Person[] findByRoleId_PrevAndNext(
		...
		try {
			...
			array[0] = getByRoleId_PrevAndNext(
				session, person, roleId, orderByComparator, true);

			array[1] = person;

			array[2] = getByRoleId_PrevAndNext(
				session, person, roleId, orderByComparator, false);
	...
	protected Person getByRoleId_PrevAndNext(
		Session session, Person person, long roleId,
		OrderByComparator<Person> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Person> findByDepartmentId(
	...
	public Person findByDepartmentId_First(
		...
		Person person = fetchByDepartmentId_First(
	...
	public Person fetchByDepartmentId_First(
		...
		List<Person> list = findByDepartmentId(
	...
	public Person findByDepartmentId_Last(
		...
		Person person = fetchByDepartmentId_Last(
			departmentId, orderByComparator);
	...
	public Person[] findByDepartmentId_PrevAndNext(
		...
		try {
			...
			array[0] = getByDepartmentId_PrevAndNext(
				session, person, departmentId, orderByComparator, true);

			array[1] = person;

			array[2] = getByDepartmentId_PrevAndNext(
				session, person, departmentId, orderByComparator, false);
	...
	protected Person getByDepartmentId_PrevAndNext(
		Session session, Person person, long departmentId,
		OrderByComparator<Person> orderByComparator, boolean previous) {
	...
	public void cacheResult(Person person) {
		...
		finderCache.putResult(
			_finderPathFetchByPersonId, new Object[] {person.getPersonId()},
			person);
	}
	...
	protected void cacheUniqueFindersCache(PersonModelImpl personModelImpl) {
		...
		args = new Object[] {personModelImpl.getPersonId()};

		finderCache.putResult(
			_finderPathCountByPersonId, args, Long.valueOf(1), false);
		finderCache.putResult(
			_finderPathFetchByPersonId, args, personModelImpl, false);
	}
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathFetchByPersonId = _createFinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByPersonId",
			new String[] {Long.class.getName()}, new String[] {"personId"},
			true);

		_finderPathCountByPersonId = _createFinderPath(
		...
		_finderPathWithPaginationFindByDepartmentId = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByDepartmentId = _createFinderPath(
	...
	private static class PersonModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= PersonModelImpl.getColumnBitmask(
				"firstName");
