...
public interface AddressLocalService
	...
	public Address patchAddress(
			long addressId, String name, ServiceContext serviceContext)
		throws PortalException;
