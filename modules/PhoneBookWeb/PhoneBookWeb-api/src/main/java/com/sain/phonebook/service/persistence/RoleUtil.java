...
public class RoleUtil {
	 ...
	 * @throws NoSuchRoleException if a matching role could not be found
	 */
	public static Role findByUnitId(long unitId)
		throws com.sain.phonebook.exception.NoSuchRoleException {
	 ...
	 * @return the matching role, or <code>null</code> if a matching role could not be found
	 */
	public static Role fetchByUnitId(long unitId) {
		return getPersistence().fetchByUnitId(unitId);
	}
	 ...
	 * @return the matching role, or <code>null</code> if a matching role could not be found
	 */
	public static Role fetchByUnitId(long unitId, boolean useFinderCache) {
		return getPersistence().fetchByUnitId(unitId, useFinderCache);
	}
	 ...
	 * @return the role that was removed
	 */
	public static Role removeByUnitId(long unitId)
		throws com.sain.phonebook.exception.NoSuchRoleException {

		return getPersistence().removeByUnitId(unitId);
	}
