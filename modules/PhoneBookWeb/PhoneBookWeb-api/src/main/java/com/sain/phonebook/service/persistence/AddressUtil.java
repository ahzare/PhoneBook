...
public class AddressUtil {
	...
	public static Address findByUuid_First(
		...
		throws com.sain.phonebook.exception.NoSuchAddressException {
	 ...
	 * @throws NoSuchAddressException if a matching address could not be found
	 */
	public static Address findByAddressId(long addressId)
		throws com.sain.phonebook.exception.NoSuchAddressException {
	 ...
	 * @return the matching address, or <code>null</code> if a matching address could not be found
	 */
	public static Address fetchByAddressId(long addressId) {
		return getPersistence().fetchByAddressId(addressId);
	}
	 ...
	 * @return the matching address, or <code>null</code> if a matching address could not be found
	 */
	public static Address fetchByAddressId(
		long addressId, boolean useFinderCache) {

		return getPersistence().fetchByAddressId(addressId, useFinderCache);
	}
	 ...
	 * @return the address that was removed
	 */
	public static Address removeByAddressId(long addressId)
		throws com.sain.phonebook.exception.NoSuchAddressException {

		return getPersistence().removeByAddressId(addressId);
	}
