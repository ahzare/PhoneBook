 ...
 * <code>com.sain.phonebook.service.impl.RoleLocalServiceImpl</code> and
...
public class RoleLocalServiceUtil {
	 ...
	 */
	public static Role fetchRoleByUuidAndGroupId(String uuid, long groupId) {
		return getService().fetchRoleByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static Role getRoleByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return getService().getRoleByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Role> getRolesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getRolesByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Role> getRolesByUuidAndCompanyId(
		...
		return getService().getRolesByUuidAndCompanyId(
