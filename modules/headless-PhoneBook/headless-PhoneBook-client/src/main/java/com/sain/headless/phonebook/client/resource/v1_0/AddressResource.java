...
public interface AddressResource {
	...
	public HttpInvoker.HttpResponse getAddressesPageHttpResponse(
			String search, String filterString, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postAddressHttpResponse(Address address)
		throws Exception;

	public void postAddressBatch(String callbackURL, Object object)
		throws Exception;

	public HttpInvoker.HttpResponse postAddressBatchHttpResponse(
	...
	public HttpInvoker.HttpResponse putAddressBatchHttpResponse(
			String callbackURL, Object object)
		throws Exception;
	...
	public static class AddressResourceImpl implements AddressResource {
		...
		public HttpInvoker.HttpResponse getAddressesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/headless-PhoneBook/v1.0/addresses");
		...
		public Address postAddress(Address address) throws Exception {
			HttpInvoker.HttpResponse httpResponse = postAddressHttpResponse(
				address);
		...
		public HttpInvoker.HttpResponse postAddressHttpResponse(Address address)
			...
			httpInvoker.body(address.toString(), "application/json");
		...
		public void postAddressBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				postAddressBatchHttpResponse(callbackURL, object);
		...
		public HttpInvoker.HttpResponse postAddressBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-PhoneBook/v1.0/addresses/batch");
		...
		public void deleteAddressBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteAddressBatchHttpResponse(callbackURL, object);
		...
		public void putAddressBatch(String callbackURL, Object object)
			...
			HttpInvoker.HttpResponse httpResponse = putAddressBatchHttpResponse(
				callbackURL, object);
