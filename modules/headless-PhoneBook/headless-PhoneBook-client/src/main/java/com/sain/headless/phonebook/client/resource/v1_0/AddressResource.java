...
public interface AddressResource {
	...
	public HttpInvoker.HttpResponse postAddressHttpResponse(
	...
	public static class AddressResourceImpl implements AddressResource {
		...
		public HttpInvoker.HttpResponse getAddressesPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-PhoneBook/v1.0/sites/{siteId}/addresses");
		...
		public Address postAddress(Long siteId, Address address)
			throws Exception {
