...
public class AddressResourceFactoryImpl implements AddressResource.Factory {
	...
	@Override
	public AddressResource.Builder create() {
		return new AddressResource.Builder() {
			...
			public AddressResource build() {
				...
				return (AddressResource)ProxyUtil.newProxyInstance(
					AddressResource.class.getClassLoader(),
					new Class<?>[] {AddressResource.class},
			...
			@Override
			public AddressResource.Builder checkPermissions(
			...
			@Override
			public AddressResource.Builder httpServletRequest(
			...
			@Override
			public AddressResource.Builder httpServletResponse(
			...
			@Override
			public AddressResource.Builder preferredLocale(
			...
			@Override
			public AddressResource.Builder user(User user) {
				_user = user;
	...
	protected void activate() {
		AddressResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		AddressResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		try {
			...
			_componentServiceObjects.ungetService(addressResource);
	...
	private ComponentServiceObjects<AddressResource> _componentServiceObjects;
