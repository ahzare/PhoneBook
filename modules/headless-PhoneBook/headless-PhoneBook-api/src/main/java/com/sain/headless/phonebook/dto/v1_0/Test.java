 ...
 */
@Generated("")
@GraphQLName(description = "its test component", value = "Test")
...
public class Test implements Serializable {
	...
	@Schema(description = "represent a test text.")
	...
	@GraphQLField(description = "represent a test text.")
	...
	@Schema(
		...
		defaultValue = "com.sain.headless.phonebook.dto.v1_0.Test",
		name = "x-class-name"
	)
