...
public abstract class BasePersonResourceTestCase {
	...
	public void testGetPersonsPage() throws Exception {
		...
		if (irrelevantSiteId != null) {
			Person irrelevantPerson = testGetPersonsPage_addPerson(
			...
			assertEquals(
				Arrays.asList(irrelevantPerson), (List<Person>)page.getItems());
			assertValid(page);
		}

		Person person1 = testGetPersonsPage_addPerson(siteId, randomPerson());
	...
	public void testGetPersonsPageWithFilterDateTimeEquals() throws Exception {
		...
		person1 = testGetPersonsPage_addPerson(siteId, person1);
	...
	protected void testGetPersonsPageWithSort(
		...
		person2 = testGetPersonsPage_addPerson(siteId, person2);
	...
	protected Person testGetPersonsPage_addPerson(Long siteId, Person person)
		throws Exception {
	...
	public void testDeletePersonApi() throws Exception {
		...
		assertHttpResponseStatusCode(
			204,
			personResource.deletePersonApiHttpResponse(null, person.getId()));
	}
