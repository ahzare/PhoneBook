...
public abstract class BasePartResourceTestCase {
	...
	public void testGetPartsPage() throws Exception {
		Page<Part> page = partResource.getPartsPage(
			testGetPartsPage_getSiteId(), RandomTestUtil.randomString(), null,
			Pagination.of(1, 2), null);

		Assert.assertEquals(0, page.getTotalCount());

		Long siteId = testGetPartsPage_getSiteId();
		Long irrelevantSiteId = testGetPartsPage_getIrrelevantSiteId();

		if (irrelevantSiteId != null) {
			Part irrelevantPart = testGetPartsPage_addPart(
				irrelevantSiteId, randomIrrelevantPart());
			...
			assertEquals(
				Arrays.asList(irrelevantPart), (List<Part>)page.getItems());
			assertValid(page);
		}

		Part part1 = testGetPartsPage_addPart(siteId, randomPart());

		Part part2 = testGetPartsPage_addPart(siteId, randomPart());
	...
	public void testGetPartsPageWithFilterDateTimeEquals() throws Exception {
		...
		part1 = testGetPartsPage_addPart(siteId, part1);

		for (EntityField entityField : entityFields) {
			Page<Part> page = partResource.getPartsPage(
				siteId, null, getFilterString(entityField, "between", part1),
				Pagination.of(1, 2), null);
	...
	public void testGetPartsPageWithFilterStringEquals() throws Exception {
		...
		for (EntityField entityField : entityFields) {
			Page<Part> page = partResource.getPartsPage(
				siteId, null, getFilterString(entityField, "eq", part1),
				Pagination.of(1, 2), null);
	...
	public void testGetPartsPageWithPagination() throws Exception {
		...
		Part part3 = testGetPartsPage_addPart(siteId, randomPart());
	...
	protected void testGetPartsPageWithSort(
		...
		part2 = testGetPartsPage_addPart(siteId, part2);
	...
	protected Part testGetPartsPage_addPart(Long siteId, Part part)
		throws Exception {
	...
	protected Long testGetPartsPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetPartsPage_getIrrelevantSiteId() throws Exception {
	...
	@Test
	public void testDeletePartApi() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		Part part = testDeletePartApi_addPart();

		assertHttpResponseStatusCode(
			204, partResource.deletePartApiHttpResponse(null, part.getId()));
	}
